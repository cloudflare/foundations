...
/// Opens fd 1 directly with a [`BUF_SIZE`] buffer.
///
/// [`io::Stdout`] is line buffered and adds unnecessary overhead for JSON output.
fn block_buffered_stdout() -> BufWriter<File> {
