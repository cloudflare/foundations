...
//!
//! This module provides a sentry hook that increments the `sentry_events_total`
//! metric for each sentry event. If a previous `before_send` hook exists, it
//! will be executed after the installed foundations hook.
//!
