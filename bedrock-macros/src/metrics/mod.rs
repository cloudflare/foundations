...
fn expand_from_parsed(args: MacroArgs, extern_: Mod) -> proc_macro2::TokenStream {
    ...
    let reexports = quote! { #bedrock::reexports_for_macros };
    ...
    let metric_fns = fns
        .iter()
        .map(|fn_| metric_fn(bedrock, &metrics_struct, fn_));
...
fn metric_field(bedrock: &Path, fn_: &ItemFn) -> proc_macro2::TokenStream {
    let ItemFn {
    ...
    {
        quote! {
            #bedrock::reexports_for_macros::prometools::serde::Family<
                #metric_name,
                #metric_ty,
                #ctor_path,
            >
...
fn label_set_struct(bedrock: &Path, fn_: &ItemFn) -> Option<proc_macro2::TokenStream> {
    let ItemFn {
        attrs: FnAttrs { cfg, .. },
        args,
...
fn metric_init(bedrock: &Path, fn_: &ItemFn) -> proc_macro2::TokenStream {
    let ItemFn {
        attrs:
            FnAttrs {
                cfg,
...
fn metric_fn(bedrock: &Path, metrics_struct: &Ident, fn_: &ItemFn) -> proc_macro2::TokenStream {
    let ItemFn {
    ...
    let fn_body = if args.is_empty() {
        ...
        quote! {
            ::std::clone::Clone::clone(
                &#bedrock::reexports_for_macros::prometools::serde::Family::get_or_create(
    ...
    fn expand_empty() {
        ...
        let expected = code_str! {
            ...
            mod empty {
                ...
                #[allow(non_upper_case_globals)]
                static __empty_Metrics: ::bedrock::reexports_for_macros::once_cell::sync::Lazy<__empty_Metrics> =
                    ::bedrock::reexports_for_macros::once_cell::sync::Lazy::new(|| { __empty_Metrics {} });
            }
        };
                    ...
                    ::bedrock::reexports_for_macros::once_cell::sync::Lazy::new(|| {
                        ...
                        __oxy_Metrics {
                            connections_total: {
                                ...
                                ::bedrock::reexports_for_macros::prometheus_client::registry::Registry::register(
                                    opt_registry,
                                    ::std::stringify!(connections_total),
                                    str::trim(" Total number of connections"),
                                    ::std::boxed::Box::new(::std::clone::Clone::clone(&metric))
    ...
    fn expand_label_set() {
        ...
        let expected = code_str! {
            pub mod oxy {
                ...
                #[allow(non_camel_case_types)]
                #[::bedrock::reexports_for_macros::serde_with::serde_as(crate = ":: bedrock :: reexports_for_macros :: serde_with")]
                #[derive(
                    ::std::clone::Clone,
                    ::std::cmp::Eq,
                    ::std::hash::Hash,
            ...
            pub mod oxy {
                ...
                static __oxy_Metrics: ::bedrock::reexports_for_macros::once_cell::sync::Lazy<__oxy_Metrics> =
                    ::bedrock::reexports_for_macros::once_cell::sync::Lazy::new(|| {
                        ...
                        __oxy_Metrics {
                            connections_latency: {
                                let metric = ::bedrock::reexports_for_macros::prometheus_client::metrics::family::MetricConstructor::new_metric(
                            ...
                            requests_per_connection: {
                                let metric = ::bedrock::reexports_for_macros::prometools::serde::Family::new_with_constructor(
